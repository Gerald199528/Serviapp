...
<div class="container-fluid p-0 mb-5 pb-5">
    <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <h1 style="font-size: 2em; color:black; font-weight: bold;">Gobernación del Estado Trujillo:</h1>
        <p style= color:black;>La Gobernación del Estado Trujillo se dedica a servir a los ciudadanos de nuestro estado, trabajando cada día para hacer de Trujillo un lugar mejor para vivir, trabajar y visitar.
